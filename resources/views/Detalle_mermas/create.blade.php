...
<body>
    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            ...
            {!! Form::open(['url'=>'/detalle_mermas']) !!}
                <div class="form-group mb-3">{!! Form::label ('cantidad','Cantidad', ['class' => 'form-label']) !!}{!! Form::number('cantidad', null, ['class' => 'form-control', 'placeholder' => 'Ingresa cantidad', 'required' => 'required', 'title' => 'Debes ingresar el cantidad']) !!}</div>
                <div class="form-group mb-3">{!! Form::label ('precio_compra','Precio de compra', ['class' => 'form-label']) !!}{!! Form::number('precio_compra', null, ['class' => 'form-control', 'placeholder' => 'Ingresa el precio_merma', 'required' => 'required', 'title' => 'Debes ingresar el precio de merma']) !!}</div>
                <div class="form-group mb-3">{!! Form::label ('precio_venta','Precio de venta', ['class' => 'form-label']) !!}{!! Form::number('precio_venta', null, ['class' => 'form-control', 'placeholder' => 'Ingresa el precio_venta', 'required' => 'required', 'title' => 'Debes ingresar el precio de merma']) !!}</div>
                <div class="form-group mb-3">
                    ...
                    <select class="form-select states order-alpha" id="merma" name="id_merma" required="">
                        @foreach($mermas as $merma)
                            <option value="{{ $merma->id }}">{{ ($merma->id)}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group mb-3">
