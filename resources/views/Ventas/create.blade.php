    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            <div class="block-heading" style="padding-top: 0px;">
                <h2 class="text-primary" style="margin-top: 100px;">Registrar ventas</h2>
                <p>Realiza el registro llenando los siguientes datos</p>
            </div>
            {!! Form::open(['url'=>'/ventas']) !!}
                <div class="form-group mb-3">{!! Form::label ('fecha','Fecha', ['class' => 'form-label']) !!}{!! Form::date('fecha', null, ['class' => 'form-control', 'placeholder' => 'Ingresa Fecha', 'required' => 'required', 'title' => 'Debes ingresar el Fecha']) !!}</div>
                <div class="form-group mb-3">{!! Form::label ('total','Total', ['class' => 'form-label']) !!}{!! Form::number('total', null, ['class' => 'form-control', 'placeholder' => 'Ingresa Total', 'required' => 'required', 'title' => 'Debes ingresar el Total']) !!}</div>
                <div class="form-group mb-3">{!! Form::label ('total_pagado','Total pagado', ['class' => 'form-label']) !!}{!! Form::number('total_pagado', null, ['class' => 'form-control', 'placeholder' => 'Ingresa el total_pagado', 'required' => 'required', 'title' => 'Debes ingresar el total_pagado']) !!}</div>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select states order-alpha" id="tipo_pago" name="id_tipo_pago" required="">
                        @foreach($tipos_pagos as $tipos_pago)
                            <option value="{{ $tipos_pago->id }}">{{ $tipos_pago->nombre }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Guardar ventas', ['class' => 'btn btn-primary d-block w-100']) !!}</div>
