    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            ...
            {!! Form::open(['url'=>'/detalle_compras']) !!}
                ...
                <div class="form-group mb-3">{!! Form::label ('precio_compra','Precio de compra', ['class' => 'form-label']) !!}{!! Form::number('precio_compra', null, ['class' => 'form-control', 'placeholder' => 'Ingresa el precio_compra', 'required' => 'required', 'title' => 'Debes ingresar el precio de compra']) !!}</div>
                <div class="form-group mb-3">{!! Form::label ('precio_venta','Precio de venta', ['class' => 'form-label']) !!}{!! Form::number('precio_venta', null, ['class' => 'form-control', 'placeholder' => 'Ingresa el precio_venta', 'required' => 'required', 'title' => 'Debes ingresar el precio de compra']) !!}</div>
