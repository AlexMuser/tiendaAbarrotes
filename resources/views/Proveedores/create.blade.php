        ...
        <div class="container" style="margin-top: -59px;">
            ...
            {!! Form::open(['url'=>'/proveedores']) !!}
                ...
                <div class="form-group mb-3">
                    ...
                    {!! Form::select('dia_visita', ['Lunes' => 'Lunes', 'Martes' => 'Martes', 'Miércoles' => 'Miércoles', 'Jueves' => 'Jueves', 'Viernes' => 'Viernes'], $proveedore->dia_visita ?? null, ['class' => 'form-control', 'placeholder' => 'Selecciona un día de la semana', 'required' => 'required']) !!}
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Guardar proveedor', ['class' => 'btn btn-primary d-block w-100']) !!}</div>
