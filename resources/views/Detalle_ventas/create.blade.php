    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            ...
            {!! Form::open(['url'=>'/detalle_ventas']) !!}
                ...
                <div class="form-group mb-3">{!! Form::label ('precio_venta','Precio de venta', ['class' => 'form-label']) !!}{!! Form::number('precio_venta', null, ['class' => 'form-control', 'placeholder' => 'Ingresa el precio_compra', 'required' => 'required', 'title' => 'Debes ingresar el precio de venta']) !!}</div>
