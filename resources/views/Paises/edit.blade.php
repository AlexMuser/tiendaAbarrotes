    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            <div class="block-heading" style="padding-top: 0px;">
                <h2 class="text-primary" style="margin-top: 100px;">Registrar paises</h2>
                <p>Realiza el registro llenando los siguientes datos</p>
            </div>
                {!! Form::open([ 'method' => 'PATCH' , 'url'=>'/paises/'.$pais->id]) !!}
                <div class="form-group mb-3">{!! Form::label ('nombre','Nombre', ['class' => 'form-label']) !!}{!! Form::text('nombre', $pais->nombre, ['class' => 'form-control', 'placeholder' => 'Ingresa el nombre', 'required' => 'required', 'title' => 'Debes ingresar el nombre']) !!}</div>
                <div class="form-group mb-3">{!! Form::label ('clave','Descripción', ['class' => 'form-label']) !!}{!! Form::text('clave', $pais->clave, ['class' => 'form-control', 'placeholder' => 'Ingresa una descripción', 'required' => 'required', 'title' => 'Debes ingresar la descripción']) !!}</div>
                <hr style="margin-top: 30px;margin-bottom: 10px;">
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Editar pais', ['class' => 'btn btn-primary d-block w-100']) !!}</div>
                <a href="{{ url('/paises') }}" class="btn btn-primary d-block w-100" style="background: rgb(237,38,38);">Cancelar</a>
                {!! Form::close() !!}
        </div>
    </section>
