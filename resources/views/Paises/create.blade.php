    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            ...
            {!! Form::open(['url'=>'/paises']) !!}
                ...
                <div class="form-group mb-3">{!! Form::label ('clave','Clave', ['class' => 'form-label']) !!}{!! Form::text('clave', null, ['class' => 'form-control', 'placeholder' => 'Ingresa una clave', 'required' => 'required', 'title' => 'Debes ingresar la Clave']) !!}</div>
                <hr style="margin-top: 30px;margin-bottom: 10px;">
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Guardar pais', ['class' => 'btn btn-primary d-block w-100']) !!}</div>    
