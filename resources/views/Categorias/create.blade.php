    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            ...
            {!! Form::open(['url'=>'/categorias']) !!}
                ...
                <div class="form-group mb-3">{!! Form::label ('descripcion','Descripción', ['class' => 'form-label']) !!}{!! Form::text('descripcion', null, ['class' => 'form-control', 'placeholder' => 'Ingresa una descripción', 'required' => 'required', 'title' => 'Debes ingresar la descripción']) !!}</div>
                <hr style="margin-top: 30px;margin-bottom: 10px;">
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Guardar categoria', ['class' => 'btn btn-primary d-block w-100']) !!}</div>    
