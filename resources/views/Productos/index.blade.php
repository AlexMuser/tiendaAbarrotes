...
<body>
    ...
    <div class="container-fluid" style="margin-top: 28px;width: 1255.6px;">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-6 text-end" style="margin-bottom: 30px;"><a class="btn btn-primary" role="button" href="{!!  asset('productos/create')   !!}">&nbsp;Agregar producto</a></div>
        </div>
        <div class="card" id="TableSorterCard">
            <div class="card-header py-3">
                <div class="row align-items-center table-topper">
                    <div class="col-12 col-sm-5 col-md-6 text-start" style="margin: 0px;padding: 5px 15px;">
                        <p class="fw-bold text-primary m-0">Productos registrados</p>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <table class="table table-striped table tablesorter" id="ipi-table">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th class="text-center">Precio para venta</th>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($tipos_ventas as $tipo_venta)
                                            @if ($producto->id_tipo_venta == $tipo_venta->id)
                                        ...
                                        @foreach($tiendas as $tienda)
                                            ...
                                            @endif
                                        @endforeach
                                        <td class="text-center align-middle" style="max-height: 60px;height: 60px;"><a class="btn btnMaterial btn-flat primary semicircle" role="button" href="{!! 'productos/'.$producto->id !!}"><i class="far fa-eye"></i></a>
                                        <a class="btn btnMaterial btn-flat success semicircle" role="button" href="{!! 'productos/'.$producto->id.'/edit' !!}"><i class="fas fa-pen"></i></a>
