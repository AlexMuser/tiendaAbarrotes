    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            <div class="block-heading" style="padding-top: 0px;">
                <h2 class="text-primary" style="margin-top: 100px;">Registrar mermas</h2>
                <p>Realiza el registro llenando los siguientes datos</p>
            </div>
            {!! Form::open(['url'=>'/mermas']) !!}
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select states order-alpha" id="usuario" name="id_usuario" required="">
                        @foreach($usuarios as $usuario)
                            <option value="{{ $usuario->id }}">{{ $usuario->nombre . " " .  $usuario->ap_pat . " " . $usuario->ap_mat}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Guardar mermas', ['class' => 'btn btn-primary d-block w-100']) !!}</div>
