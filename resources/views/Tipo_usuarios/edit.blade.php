    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            <div class="block-heading" style="padding-top: 0px;">
                ...
                {!! Form::open([ 'method' => 'PATCH' , 'url'=>'/tipo_usuarios/'.$tipo_usuario->id]) !!}
                <div class="form-group mb-3">{!! Form::label ('nombre','Nombre', ['class' => 'form-label']) !!}{!! Form::text('nombre', $tipo_usuario->nombre, ['class' => 'form-control', 'placeholder' => 'Ingresa el nombre', 'required' => 'required', 'title' => 'Debes ingresar el nombre']) !!}</div>
                <div class="form-group mb-3">{!! Form::label ('cargo','Cargo', ['class' => 'form-label']) !!}{!! Form::text('cargo', $tipo_usuario->cargo, ['class' => 'form-control', 'placeholder' => 'Ingresa un cargo', 'required' => 'required', 'title' => 'Debes ingresar el cargo']) !!}</div>
                <hr style="margin-top: 30px;margin-bottom: 10px;">
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Editar tipo de usuario', ['class' => 'btn btn-primary d-block w-100']) !!}</div>
