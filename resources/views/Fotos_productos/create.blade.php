    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            <div class="block-heading" style="padding-top: 0px;">
                <h2 class="text-primary" style="margin-top: 100px;">Registrar foto de un producto</h2>
            ...
            {!! Form::open(['url'=>'/fotos_productos','enctype'=>'multipart/form-data']) !!}
                <div class="form-group mb-3">
                    ...
                    <select class="form-select states order-alpha" id="id_producto" name="id_producto" required="">
                ...
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Guardar foto del producto', ['class' => 'btn btn-primary d-block w-100']) !!}</div>
