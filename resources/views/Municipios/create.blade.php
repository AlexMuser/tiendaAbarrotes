        ...
        <div class="container" style="margin-top: -59px;">
            ...
            {!! Form::open(['url'=>'/municipios']) !!}
                <div class="form-group mb-3">
                    ...
                    {!! Form::select('id_pais', $paises->pluck('nombre','id')->all(), null, ['class'=>'form-select states order-alpha', 'placeholder'=>'Seleccionar ...', 'onchange'=>'cambiar_combo(this.value);', 'required'=>'required']) !!}
                </div>
                <div class="form-group mb-3">
                    {!! Form::label('id_entidad', 'Entidad:', ['class'=>'form-label']) !!}
                    {!! Form::select('id_entidad', [], null, ['class'=>'form-select', 'placeholder'=>'Seleccionar ...', 'required'=>'required']) !!}
                </div>
                <div class="form-group mb-3">
                    {!! Form::label('nombre', 'Nombre del municipio:', ['class'=>'form-label']) !!}
                    {!! Form::text('nombre', null, ['class'=>'form-control', 'placeholder'=>'Ingresa el nombre del municipio', 'required'=>'required', 'title'=>'Debes ingresar el nombre']) !!}
                </div>
