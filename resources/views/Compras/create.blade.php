    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            <div class="block-heading" style="padding-top: 0px;">
                <h2 class="text-primary" style="margin-top: 100px;">Registrar compras</h2>
            ...
            {!! Form::open(['url'=>'/compras']) !!}
                ...
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Guardar compras', ['class' => 'btn btn-primary d-block w-100']) !!}</div>
