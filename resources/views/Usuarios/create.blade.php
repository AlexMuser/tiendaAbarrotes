    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            ...
            {!! Form::open(['url'=>'/usuarios']) !!}
                ...
                <div class="form-group mb-3">{!! Form::label ('telefono','Teléfono', ['class' => 'form-label']) !!}{!! Form::tel('telefono', null, ['class' => 'form-control', 'placeholder' => 'Ingresa el teléfono', 'required' => 'required', 'title' => 'Debes de ingresar un correo electronico']) !!}</div>
                <div class="form-group mb-3">{!! Form::label ('email','Correo electronico', ['class' => 'form-label']) !!}{!! Form::email('email', null, ['class' => 'form-control', 'placeholder' => 'Ingresa el correo', 'required' => 'required', 'title' => 'Debes de ingresar un numero de teléfono']) !!}</div>
                ...
                <div class="form-group mb-3">{!! Form::label ('username','Usuario', ['class' => 'form-label']) !!}{!! Form::text('username', null, ['class' => 'form-control', 'placeholder' => 'Ingresa el usuario', 'required' => 'required', 'title' => 'Debes de ingresar un nombre de usuario']) !!}</div>
                ...
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Guardar usuario', ['class' => 'btn btn-primary d-block w-100']) !!}</div>
