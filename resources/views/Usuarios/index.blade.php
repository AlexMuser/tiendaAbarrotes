...
<body>
    ...
    <div class="container-fluid" style="margin-top: 28px;width: 1255.6px;">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-6 text-end" style="margin-bottom: 30px;"><a class="btn btn-primary" role="button" href="{!!  asset('usuarios/create')   !!}">&nbsp;Agregar usuario</a></div>
        </div>
        <div class="card" id="TableSorterCard">
            <div class="card-header py-3">
                <div class="row align-items-center table-topper">
                    <div class="col-12 col-sm-5 col-md-6 text-start" style="margin: 0px;padding: 5px 15px;">
                        <p class="fw-bold text-primary m-0">Usuarios registrados</p>
                    </div>
                </div>
            </div>
            <div class="row">
