    ...
    <section class="clean-block clean-form dark h-100">
        <div class="container" style="margin-top: -59px;">
            ...
            {!! Form::open(['url'=>'/entidades']) !!}
                <div class="form-group mb-3">{!! Form::label ('nombre','Nombre', ['class' => 'form-label']) !!}{!! Form::text('nombre', null, ['class' => 'form-control', 'placeholder' => 'Ingresa Nombre', 'required' => 'required', 'title' => 'Debes ingresar el Nombre']) !!}</div>
                ...
                <div class="form-group mb-3">&nbsp;{!! Form::submit('Guardar entidad', ['class' => 'btn btn-primary d-block w-100']) !!}</div>
